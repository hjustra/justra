...
O mesmo `output_tag` permite checkpoint. Se a coleta diaria ficar parcial, as proximas janelas retomam de onde parou. A politica inicial usa `FALCAO_REQUEST_BUDGET=200` por disparo para evitar uma execucao infinita; depois de observarmos estabilidade, esse limite pode subir.
...
FALCAO_MIN_DELAY_MS=30000
FALCAO_MAX_DELAY_MS=90000
FALCAO_REQUEST_BUDGET=200
